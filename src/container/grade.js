                                    ...
                                    <Table>
                                        ...
                                        <TableBody displayRowCheckbox={false}>
                                            ...
                                            <TableRow>
                                                ...
                                                <TableRowColumn style={{ fontSize: styleReduce ? '16px' :  contentFontSize, width: '49%'  }}>GPA: { !sem.verify ? '-' : (sem.grade/sem.credit).toFixed(2) }</TableRowColumn>
                                                <TableRowColumn style={{ fontSize: styleReduce ? '16px' : contentFontSize, width: '49%' }}>GPAX: { !sem.verify ? '-' : (sem.gradeX/sem.creditX).toFixed(2)} </TableRowColumn>
                                            </TableRow>
                                        </TableBody>
                                    </Table>
                                </div>
